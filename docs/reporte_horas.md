# Reporte de horas — PlomerIA (Grupo 14)

Materia: Desarrollo de Software · UNAB · Entrega: 17/06/2026

> Cada integrante completa su propia sección (actividades y horas).

---

## Aldana Benavent
**Rol:** Frontend, diseño/UX, diagramas, idea y gestión del proyecto.

- Concepción de la idea general del proyecto.
- Creación del repositorio en GitHub y de la estructura general.
- Armado y gestión del tablero de Trello (fui sumando actividades).
- Desarrollo completo del frontend.
- Mejoras puntuales del backend para poder seguir probando el frontend.
- Aporte de las ideas de mejora y sugerencia de refactors para revisar errores.
- Creación de la lista de plomeros ficticios.
