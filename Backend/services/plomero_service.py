...
def registrar(db: Session, datos: PlomeroRequest) -> dict:
    ...
    # Agregamos latitud y longitud para que coincida con el Model de Plomero
    nuevo = Plomero(
        nombre            = datos.nombre,
        ...
        latitud           = datos.latitud,   # ← Agregado para Geopy
        longitud          = datos.longitud,  # ← Agregado para Geopy
